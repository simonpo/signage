...
class FerryMapRenderer:
    ...
    def _is_valid_position(self, pos: Tuple[int, int]) -> bool:
        ...
        x, y = pos
        return (self.MARGIN <= x <= self.MAP_WIDTH - self.MARGIN and
                300 <= y <= self.MAP_HEIGHT - 100)
    ...
    def _draw_vessel(
        ...
        if vessel.speed and vessel.speed > 1:
            ...
            end_y = y - arrow_length * math.cos(heading_rad)  # Negative because screen y is inverted
