...
from src.models.signage_data import SportsData, SportsResult, SportsFixture, LeagueTableRow
...
class FootballClient(BaseSportsClient):
    ...
    def _make_request(self, endpoint: str) -> Optional[dict]:
        ...
        logger.error(f"Football API request failed: {response.status_code if response else 'No response'}")
        return None
